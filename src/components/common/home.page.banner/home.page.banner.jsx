        ...
        <Paper elevation={0} className='position-relative w-100 header'>
            <div className={clsx('d-flex w-100 h-100')}>
                ...
                <div className={clsx(mobileWidth && 'pt-5', 'position-absolute d-flex h-100 w-100 justify-content-start align-items-center')}>
                    <div className={clsx(!mobileWidth && 'w-50 pl-5 ml-3', mobileWidth && 'w-70 ml-3 pl-4')}>
                        <p className={clsx(!mobileWidth && 'text-style', mobileWidth && 'text-style responsive-text-style')}>
                            {title ? title : ''}
                        </p>
                        <p className='mt-4 mb-4 text-style-2'>
                            {label ? label : ''}
                        </p>
                        {footer ?
