...
import Logo from '../../../assets/images/PoshDubbing.svg';
    ...
    return (
        <div className="position-relative">
            {!(mobileWidth || tabletWidth) ?
                <AppBar position="absolute" classes={{ root: classes.appNavbar }} className='m-auto'>
                    <Container maxWidth='xl' className='p-0'>
                        <Toolbar className={clsx(!mobileWidth && "d-flex flex-row justify-content-between align-items-center m-auto")}>
                            ...
                            {isToShowNavbarButtons(location) ?
                                ...
                                :
                                <select className={clsx(classes.selectStyle, 'pl-3 pr-3 p-2')} onChange={(e) => onChange('translateFrom', e.target.value)}>
            ...
            >
                ...
                >
                    <div className="d-flex flex-column justify-content-center align-items-center">
                        <Link onClick={hideDrawer} to="home" spy={true} smooth={true} offset={50} duration={500}>
                            <Button
                                classes={{ root: classes.btn }}
                                variant="none"
                            >
                        ...
                        <Link onClick={hideDrawer} to="about-us" spy={true} smooth={true} offset={50} duration={500}>
                            <Button
                                classes={{ root: classes.btn }}
                                variant="none"
                            >
                        ...
                        <Link onClick={hideDrawer} to="pricing" spy={true} smooth={true} offset={50} duration={500}>
                            <Button
                                classes={{ root: classes.btn }}
                                variant="none"
                            >
                        ...
                        <Link onClick={hideDrawer} to="faqs" spy={true} smooth={true} offset={50} duration={500}>
                            <Button
                                classes={{ root: classes.btn }}
                                variant="none"
                            >
                        ...
                        <Link onClick={hideDrawer} to="contact-us" spy={true} smooth={true} offset={50} duration={500}>
                            <Button
                                classes={{ root: classes.btn }}
                                variant="none"
                            >
